          ...
          {services.map((item, index) => (
            <motion.div
              ...
              className={`
                ...
                ${item.bgColor.includes("gradient") ? item.bgColor : item.bgColor}
                dark:bg-gray-900
            ...
            >
              <div>
                ...
                <p className="text-slate-600 dark:text-gray-300 leading-relaxed text-sm lg:text-base">
                  {item.description}
                </p>
              </div>
