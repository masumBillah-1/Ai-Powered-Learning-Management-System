...
<<<<<<< HEAD
              ...
              <a href="#" className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 group">
                <div className="w-8 h-8 flex items-center justify-center bg-pink-100 dark:bg-pink-900/30 rounded-full text-pink-600 dark:text-pink-400 group-hover:scale-110 transition-transform"><FaInstagram /></div> ইন্সটাগ্রাম
              </a>
              <a href="#" className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 group">
                <div className="w-8 h-8 flex items-center justify-center bg-red-100 dark:bg-red-900/30 rounded-full text-red-600 dark:text-red-400 group-hover:scale-110 transition-transform"><FaYoutube /></div> ইউটিউব
              </a>
              <a href="#" className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 group">
