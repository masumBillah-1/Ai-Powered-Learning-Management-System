...
const ProblemSolution = () => {
  ...
  return (
    <section className="py-8 md:py-12 bg-white dark:bg-[#020617] overflow-hidden relative">
      <div className="mx-auto container px-3 sm:px-6 lg:px-10">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 relative">
              ...
              {data.map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col gap-6 md:gap-12 lg:gap-16 relative z-10"
                >
                  {/* Problem Card */}
                  <motion.div
                    ...
                    className={`bg-gradient-to-br ${item.pColor} p-6 lg:h-40 md:p-8 rounded-[2rem] md:rounded-[3.5rem] min-h-[160px] md:min-h-[220px] flex flex-col items-center justify-center text-center shadow-2xl border border-white/5`}
                  >
                    <span className="text-3xl md:text-5xl mb-3 md:mb-4 drop-shadow-2xl">
                      {item.problemEmoji}
                    </span>
                    <p className="text-sm md:text-[15px] font-bold leading-relaxed px-1">
                      {item.problem}
                    </p>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    className={`bg-gradient-to-br ${item.sColor} p-6 lg:h-40 md:p-8 rounded-[2rem] md:rounded-[3.5rem] min-h-[160px] md:min-h-[220px] flex flex-col items-center justify-center text-center shadow-2xl border border-white/5`}
                  >
                    <span className="text-3xl md:text-5xl mb-3 md:mb-4 drop-shadow-2xl">
                      {item.solutionEmoji}
                    </span>
