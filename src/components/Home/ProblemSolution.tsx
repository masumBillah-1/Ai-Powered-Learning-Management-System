      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          >
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400">Transforming Struggles</span>
          </motion.div>
          
          <h2 className="text-4xl md:text-7xl font-black text-slate-800 dark:text-white leading-[1.1] tracking-tight">
            শেখার পথে <span className="text-rose-500">প্যারা</span> অনেক,<br />
            <span className="italic font-serif font-light text-slate-400 dark:text-slate-500">কিন্তু সমাধান মাত্র</span> <span className="bg-gradient-to-r from-rose-500 to-orange-500 bg-clip-text text-transparent">একটিই!</span>
          </h2>
        </div>
          ...
          {data.map((item, index) => (
            ...
            >
              <div className="relative h-full bg-slate-50 dark:bg-slate-900/40 backdrop-blur-3xl rounded-[3rem] border border-slate-200 dark:border-slate-800 p-8 md:p-12 overflow-hidden transition-all duration-500 hover:border-rose-500/30">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mb-10">
                    <div className="flex items-center gap-3 mb-6">
                       ...
                       <span className="text-xs font-bold uppercase tracking-widest text-slate-400">Common Struggle</span>
                    </div>
                  ...
                  <div className="mt-auto relative">
                    ...
                    <div className="relative">
                      <div className="flex items-center gap-3 mb-4">
                        <span className="text-xs font-black uppercase tracking-[0.2em] text-emerald-500">The Ultimate Solution</span>
                      </div>
                      <div className="flex items-start gap-4">
                        <span className="text-4xl mt-1 drop-shadow-lg">{item.solutionEmoji}</span>
                        <p className={`text-xl md:text-2xl font-black leading-tight bg-gradient-to-r ${item.color} bg-clip-text text-transparent`}>
                          {item.solution}
                        </p>
                      </div>
                    </div>
                ...
                {/* Bottom Glow Bar */}
                <div className={`absolute bottom-0 left-0 h-1.5 w-0 bg-gradient-to-r ${item.color} transition-all duration-700 group-hover:w-full`} />
              </div>
            </motion.div>
          ))}
        </div>
