...
export default function SplashScreen() {
    ...
    return (
        ...
        .logo-float { animation: logoFloat 1.2s ease-in-out infinite; }
        ...
        .orbit-1 { animation: orbitSpin 1s linear infinite; }
        .orbit-2 { animation: orbitSpinReverse 1.5s linear infinite; }
      ...
      `}</style>
            ...
            <div className="splash-container fixed inset-0 z-[9999] bg-animate min-h-screen flex items-center justify-center overflow-hidden">
